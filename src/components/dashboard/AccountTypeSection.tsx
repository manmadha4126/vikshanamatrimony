...
const AccountTypeSection = ({ isPrime, primeExpiresAt }: AccountTypeSectionProps) => {
  return (
    <div className="container mx-auto px-4 py-4">
      <div className="flex items-center gap-4 bg-gradient-to-r from-muted/50 to-muted rounded-xl p-4">
        <div className="flex items-center gap-3 flex-1">
          <div className="flex gap-2">
            ...
            <Button
              variant={isPrime ? 'default' : 'outline'}
              size="sm"
              className={isPrime ? 'bg-gradient-to-r from-amber-500 to-yellow-500 hover:from-amber-600 hover:to-yellow-600 text-foreground' : ''}
            >
        ...
        {!isPrime && (
          <Card className="bg-gradient-to-r from-amber-500/10 to-yellow-500/10 border-amber-500/20 p-3">
            <div className="flex items-center gap-3">
              ...
              <Button size="sm" className="bg-gradient-to-r from-amber-500 to-yellow-500 hover:from-amber-600 hover:to-yellow-600 text-foreground">
                Subscribe
              </Button>
            </div>
          </Card>
