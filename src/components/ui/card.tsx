...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({
  className,
  ...props
}, ref) => <div ref={ref} className={cn("rounded-lg glass-card text-card-foreground", className)} {...props} />);
...
const CardContent = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({
  className,
  ...props
}, ref) => <div ref={ref} className={cn("p-6 pt-0 rounded-3xl shadow-lg opacity-100 border-8 border-solid border-secondary px-[90px] py-[40px] my-0 mx-[50px]", className)} {...props} />);
